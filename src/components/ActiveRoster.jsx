...
export const ActiveRoster = ({ players, loading, onSelectPlayer }) => {
  return (
    ...
    <img
      ...
      alt={player.name}
      style={{ width: '100%', height: 250, objectFit: 'cover', borderRadius: 4, marginBottom: '0.75rem' }}
    />
  ) : (
    <div style={{ width: '100%', height: 250, background: '#eee', borderRadius: 4, marginBottom: '0.75rem' }} />
  )}
